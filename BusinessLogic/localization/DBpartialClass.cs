namespace Business_Logic
{
    ...
    public class tblFamilyMetaData
    {
        ...
        [localizedSystemDisplayName("tblFamily.oneParentOnly")]
        public object oneParentOnly { get; set; }
    ...
    public class tblStudentMetaData
    {
        ...
        [localizedSystemDisplayName("tblStudent.distanceFromSchool")]
        public object distanceFromSchool { get; set; }

        [localizedSystemDisplayName("tblStudent.siblingAtSchool")]
        public object siblingAtSchool { get; set; }

        [localizedSystemDisplayName("tblStudent.specialRequest")]
        public object specialRequest { get; set; }

        [localizedSystemDisplayName("tblStudent.request")]
